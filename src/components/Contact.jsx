      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <form className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-[#1E3A8A] text-white p-3 rounded hover:bg-[#F59E0B]"
              >
                Send Message
              </motion.button>
            </form>
          ...
          <div>
            ...
            <p className="text-[#1E3A8A] mb-4">
              <strong>Address:</strong> 123 Bus Lane, Jaipur, Rajasthan, India
            </p>
            <p className="text-[#1E3A8A]">
              Our team is available 24/7 to assist with bookings, inquiries, or
              support.
            </p>
          </div>
        </div>
